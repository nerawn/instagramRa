<template>
<nav class="whirl flex jc-center family-apple fw-600">
    <ul class="center flex   align-center">
        <nuxt-link :to=" '/profile/' + $route.params.username "  tag="li" class="posts">
            <svg aria-label="Gönderiler" class="_8-yf5 " fill="#262626" height="12" viewBox="0 0 48 48" width="12">
                <path cnuxt-linkp-rule="evenodd" d="M45 1.5H3c-.8 0-1.5.7-1.5 1.5v42c0 .8.7 1.5 1.5 1.5h42c.8 0 1.5-.7 1.5-1.5V3c0-.8-.7-1.5-1.5-1.5zm-40.5 3h11v11h-11v-11zm0 14h11v11h-11v-11zm11 25h-11v-11h11v11zm14 0h-11v-11h11v11zm0-14h-11v-11h11v11zm0-14h-11v-11h11v11zm14 28h-11v-11h11v11zm0-14h-11v-11h11v11zm0-14h-11v-11h11v11z" fill-rule="evenodd"></path>
            </svg>
            <span>GÖNDERİLER</span>
        </nuxt-link>
        <nuxt-link :to=" '/profile/' + $route.params.username + '/reels' " tag="li" class="igtv">
            <svg aria-label="Reels" class="_8-yf5 " fill="#8e8e8e" height="12" viewBox="0 0 48 48" width="12">
        ...
        <nuxt-link :to=" '/profile/' + $route.params.username + '/igtv' " tag="li" class="saved">
        ...
        <nuxt-link :to=" '/profile/' + $route.params.username + '/tags' " tag="li" class="tags">
