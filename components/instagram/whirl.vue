<template>
  <nav class="whirl flex jc-center family-apple fw-600">
    <ul class="center flex align-center">
      ...
      <nuxt-link
        :to="'/profile/' + $route.params.username + '/reels'"
        tag="li"
        class="igtv"
        v-if="info.total_clips_count > 0"
      >
        <svg
          aria-label="Reels"
          class="_8-yf5"
      ...
      <!-- <nuxt-link
        :to="'/profile/' + $route.params.username + '/igtv'"
        tag="li"
        class="saved"
        v-if="info.total_igtv_videos > 0"
      >
        <svg
          aria-label="Gönderiler"
          class="_8-yf5"
      ...
      <nuxt-link
        :to="'/profile/' + $route.params.username + '/tags'"
        tag="li"
        class="tags"
      >
        <svg
